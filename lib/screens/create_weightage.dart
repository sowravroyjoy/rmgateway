...
import 'package:rmgateway/screens/update_weightage.dart';
import 'package:rmgateway/screens/view_lead.dart';

class CreateWeightage extends StatefulWidget {
  const CreateWeightage({Key? key}) : super(key: key);

  @override
  State<CreateWeightage> createState() => _CreateWeightageState();
}

class _CreateWeightageState extends State<CreateWeightage> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection("weightage");
                                              ...
                                              for (var doc in querySnapshot.docs) {
                                                if(doc["docID"] == storedocs[i]["docID"]){
                                                  Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                          builder: (context) => UpdateWeightage(weightageModel: doc,)));
                                                }
                                              }
                                            });
                                          },
    ...
    return Scaffold(
      ...
      body: AlertDialog(
        ...
        title: Center(child: Text("Create Weightage")),
  ...
  void AddData() async{
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          backgroundColor: Colors.green, content: Text("New weightage added!!")));
    }
    else{
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
