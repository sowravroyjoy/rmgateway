...
import 'package:rmgateway/screens/update_course_level.dart';
...
class CreateCourseLevel extends StatefulWidget {
  const CreateCourseLevel({Key? key}) : super(key: key);

  @override
  State<CreateCourseLevel> createState() => _CreateCourseLevelState();
}

class _CreateCourseLevelState extends State<CreateCourseLevel> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection("courselevels");
                                              ...
                                              for (var doc in querySnapshot.docs) {
                                                if(doc["docID"] == storedocs[i]["docID"]){
                                                  Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                          builder: (context) => UpdateCourseLevel(courseLevelModel: doc,)));
                                                }
                                              }
                                            });
                                          },
    ...
    return Scaffold(
      ...
      body: AlertDialog(
        ...
        title: Center(child: Text("Create Course Level")),
  ...
  void AddData() async{
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          backgroundColor: Colors.green, content: Text("New course level added!!")));
