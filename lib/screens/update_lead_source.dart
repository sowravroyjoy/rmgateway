...
class UpdateLeadSource extends StatefulWidget {
  final QueryDocumentSnapshot<Object?> leadSourceModel;
  const UpdateLeadSource({Key? key, required this.leadSourceModel}) : super(key: key, );

  @override
  State<UpdateLeadSource> createState() => _UpdateLeadSourceState();
}

class _UpdateLeadSourceState extends State<UpdateLeadSource> {
  ...
  void initState() {
    ...
    nameEditingController = TextEditingController(text: widget.leadSourceModel["name"]);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: AlertDialog(
        ...
        title: Center(child: Text("Edit Lead Source")),
  ...
  void AddData() async{
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          backgroundColor: Colors.green, content: Text("Lead Source updated!!")));

      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => CreateLeadSource()));
