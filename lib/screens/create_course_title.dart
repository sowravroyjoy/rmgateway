...
class CreateCourseTitle extends StatefulWidget {
  const CreateCourseTitle({Key? key}) : super(key: key);

  @override
  State<CreateCourseTitle> createState() => _CreateCourseTitleState();
}

class _CreateCourseTitleState extends State<CreateCourseTitle> {
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseFirestore.instance.collection("coursetitles");
                                              ...
                                              for (var doc in querySnapshot.docs) {
                                                if(doc["docID"] == storedocs[i]["docID"]){
                                                  Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                          builder: (context) => UpdateCourseTitle(courseTitleModel: doc,)));
                                                }
                                              }
                                            });
                                          },
    ...
    return Scaffold(
      ...
      body: AlertDialog(
        ...
        title: Center(child: Text("Create Course Title")),
  ...
  void AddData() async{
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          backgroundColor: Colors.green, content: Text("New course title added!!")));
