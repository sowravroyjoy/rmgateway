...
class UpdateLead extends StatefulWidget {
  ...
  const UpdateLead({Key? key, required this.leadModel}) : super(key: key);
...
class _UpdateLeadState extends State<UpdateLead> {
  ...
  var lastNameEditingController  ;
  var emailEditingController  ;
  var phoneEditingController  ;
  var originCountryEditingController  ;
  var optionalPhoneEditingController  ;
  var immigrationHistoryEditingController  ;
  var commentsEditingController  ;
  var preQTitleEditingController  ;
  var recQTitleEditingController   ;
  var workExperienceEditingController ;
  var studyGapEditingController ;
  var ieltsResultEditingController ;
  var statusDesEditingController  ;
  var leadSourceDesEditingController  ;
  ...
  //  reload everything
     firstNameEditingController = new TextEditingController(text: widget.leadModel["firstName"]);
     lastNameEditingController = new TextEditingController(text: widget.leadModel["lastName"]);
     emailEditingController = new TextEditingController(text: widget.leadModel["email"]);
     phoneEditingController = new TextEditingController(text: widget.leadModel["phone"]);
     originCountryEditingController = new TextEditingController(text: widget.leadModel["originCountry"]);
     optionalPhoneEditingController = new TextEditingController(text: widget.leadModel["optionalPhone"]);
     immigrationHistoryEditingController = new TextEditingController(text: widget.leadModel["immigrationHistory"]);
     commentsEditingController = new TextEditingController(text: widget.leadModel["comments"]);
     preQTitleEditingController = new TextEditingController(text: widget.leadModel["preQTitle"]);
     recQTitleEditingController = new TextEditingController(text: widget.leadModel["recQTitle"]);
     workExperienceEditingController = new TextEditingController(text: widget.leadModel["workExperience"]);
     studyGapEditingController = new TextEditingController(text: widget.leadModel["studyGap"]);
     ieltsResultEditingController = new TextEditingController(text: widget.leadModel["ieltsResult"]);
     statusDesEditingController = new TextEditingController(text: widget.leadModel["statusDes"]);
     leadSourceDesEditingController = new TextEditingController(text: widget.leadModel["leadSourceDes"]);
     taskSubjectEditingController = new TextEditingController(text: widget.leadModel["taskSubject"]);
     taskContactEditingController = new TextEditingController(text: widget.leadModel["taskContact"]);
  ...
  //   dropdown
    ...
    _chosenRecQLevel = widget.leadModel["recQLevel"];
    _chosenIelts = widget.leadModel["ielts"];
    _chosenFirstChoice = widget.leadModel["firstChoice"];
    _chosenSecondChoice = widget.leadModel["secondChoice"];
    _chosenThirdChoice = widget.leadModel["thirdChoice"];
    _chosenFourthChoice = widget.leadModel["fourthChoice"];
    _chosenStatus = widget.leadModel["status"];
    _chosenLeadSource = widget.leadModel["leadSource"];
    _chosenWeightage = widget.leadModel["weightage"];
    _chosenAssigned = widget.leadModel["assigned"];
    _chosenUniversity = widget.leadModel["universityName"];
    _chosenIntakeMonthApplied = widget.leadModel["intakeMonthApplied"];
    _chosenIntakeYearApplied = widget.leadModel["intakeYearApplied"];
  ...
  //  files
    applicationFormName = widget.leadModel["docApplicationForm"];
    cvName = widget.leadModel["docCV"];
    academicName = widget.leadModel["docAcademic"];
    attendanceName = widget.leadModel["docAttendance"];
    workExperienceName = widget.leadModel["docWorkExperience"];
    sopName = widget.leadModel["docSOP"];
    passportName = widget.leadModel["docPassport"];
  ...
  void AddData() async {
    try{
      ...
      bool isUploaded = await uploadFiles(ref.id, ref);
      bool isDocument = await uploadDocuments(ref.id, ref);


      if(isUploaded && isDocument){
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            backgroundColor: Colors.green, content: Text("Lead Updated!!")));
        Navigator.pushReplacement(
            context, MaterialPageRoute(builder: (context) => ViewLead()));
        setState(() {
          _process = false;
  ...
  void getImage() async{
    ...
    applicationForm = await  FirebaseStorage.instance.ref().child("files/${widget.leadModel["docID"]}/${widget.leadModel["docApplicationForm"]}").getData(oneMegabyte);
    cv = await  FirebaseStorage.instance.ref().child("files/${widget.leadModel["docID"]}/${widget.leadModel["docCV"]}").getData(oneMegabyte);
    academic = await  FirebaseStorage.instance.ref().child("files/${widget.leadModel["docID"]}/${widget.leadModel["docAcademic"]}").getData(oneMegabyte);
    attendance = await  FirebaseStorage.instance.ref().child("files/${widget.leadModel["docID"]}/${widget.leadModel["docAttendance"]}").getData(oneMegabyte);
    workExperience = await  FirebaseStorage.instance.ref().child("files/${widget.leadModel["docID"]}/${widget.leadModel["docWorkExperience"]}").getData(oneMegabyte);
    sop = await  FirebaseStorage.instance.ref().child("files/${widget.leadModel["docID"]}/${widget.leadModel["docSOP"]}").getData(oneMegabyte);
    passport = await  FirebaseStorage.instance.ref().child("files/${widget.leadModel["docID"]}/${widget.leadModel["docPassport"]}").getData(oneMegabyte);
  ...
  Future<bool> uploadFiles(String id, DocumentReference<Map<String, dynamic>> ref) async{
    ...
    if(cvName!=null&& cvName != widget.leadModel["docCV"]){
    ...
    if(academicName!=null&& academicName != widget.leadModel["docAcademic"]){
    ...
    if(attendanceName!=null&& attendanceName != widget.leadModel["docAttendance"]){
    ...
    if(workExperienceName!=null&& workExperienceName != widget.leadModel["docWorkExperience"]){
    ...
    if(sopName!=null&& sopName != widget.leadModel["docSOP"]){
    ...
    if(passportName!=null&& passportName != widget.leadModel["docPassport"]){
    ...
    if(sponsorName!=null&& sponsorName != widget.leadModel["docSponsor"]){
    ...
    if(ieltsTestName!=null&& ieltsTestName != widget.leadModel["docIELTSTest"]){
    ...
    if(bankName!=null&& bankName != widget.leadModel["docBank"]){
